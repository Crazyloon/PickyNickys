...
const Home = () => {
  return ( 
    <>
      <img src="https://github.com/Crazyloon/PickyNickys/blob/main/public/images/brand_full.jpg" className="hero"/>
      ...
      <PictureInfoCard imgName="https://github.com/Crazyloon/PickyNickys/blob/main/public/chocolate_chip_cookies.jpg" imgAlt="Extra Large Chocolate Chip Cookies" description={'My extra large chocolate chip cookies are a dream come true. These are the first item I ever baked, before I knew there were any "rules" about standard cookie sizes. They don\'t drive much of a profit, but provide a lot of happiness!'}/>
    </>
  );
}
